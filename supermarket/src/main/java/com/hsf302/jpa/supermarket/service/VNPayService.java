...
public class VNPayService {
    ...
    public String createPaymentUrl(String txn, Long totalPrice, HttpServletRequest req) throws UnsupportedEncodingException {
    ...
    public String querryTransaction(HttpServletRequest req) throws IOException {
